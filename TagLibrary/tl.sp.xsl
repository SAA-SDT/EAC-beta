...
<xsl:include href="tl_adds.sp.xsl"/>
...
<xsl:template name='tocref'>
		...
		<a style='font-size:xx-small;text-decoration:none;font-family:arial;color:white;background-color:{$forecolor}' href='#toc'>&#160;TABLA DE CONTENIDO&#160;</a>
	</p>
</xsl:template>
